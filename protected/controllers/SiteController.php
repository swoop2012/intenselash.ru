...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$data = Product::model()->findAll(array(
            'order'=>'t.Position','together'=>true,'condition'=>'t.Active=:avaible','params'=>array(':avaible'=>1),
        ...
        $delivery = OfferDelivery::model()->findAll('t.Active=:active',array(':active'=>1));
        $payment  = OfferPayment::model()->findAll();
		$this->render('index',compact('data','article','model','delivery','payment','bonuses'));
	}
    ...
    public function actionTest(){
        VarDumper::dump(Basket::clearBasket());
    }
}